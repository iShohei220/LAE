...
class PlanarFlow(nn.Module):
    def __init__(self, nz):
        ...
        self.fc1 = nn.Linear(nz, 1)
        self.fc2 = nn.Linear(1, nz, bias=False)
    ...
    def forward(self, z):
        ...
        # (N x 1) * (1 x nz) -> N x nz
        psi = h.cosh().pow(2).reciprocal() * self.fc1.weight
        det = torch.abs(1 + psi.matmul(self.fc2.weight))

        return z, torch.log(det)
