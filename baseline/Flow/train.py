...
def run(rank, args):
    ...
    # Model
    model = FlowVAE(args.size, nx, args.nh, args.nz).to(rank)
    ...
    if args.log_dir is None:
        log_dir = f"{args.dataset}-{args.size}-FlowVAE-nh{args.nh}-nz{args.nz}-lr{args.lr}-epoch{args.epoch}-seed{args.seed}"
    else:
